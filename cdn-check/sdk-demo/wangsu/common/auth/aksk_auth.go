...
import (
	...
	"encoding/hex"
	"fmt"
	"github.com/clouddragongong/go-cdn-check/cdn-check/sdk-demo/wangsu/common/constant"
	"github.com/clouddragongong/go-cdn-check/cdn-check/sdk-demo/wangsu/common/model"
	"github.com/clouddragongong/go-cdn-check/cdn-check/sdk-demo/wangsu/common/util"
	"net/url"
	"sort"
	"strconv"
	"strings"
